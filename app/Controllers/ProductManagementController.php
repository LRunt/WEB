        ...
        public function show(string $pageTitle): string{
            ...
            if(isset($_POST['action'])){
                if($_POST['action'] == 'logout'){
                    ...
                    if($this->db->haveProductReview($_POST['id_produkt'])){
                        $tplData['success'] = "WARNING";
                        $tplData['delete'] = "S produktem s ID:$_POST[id_produkt] jsou spojené recenze, proto jej nejde smazat. <br> Pokud chcete produkt smazat, budete muset nejdříve smazat recenze s ním spojené";
                    }else{
